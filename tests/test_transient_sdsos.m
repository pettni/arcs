...
function test_radiant1(testCase)
  ...
  verifyEqual(testCase, is_transient_nlin_sdsos(r, {{fx1, x}}, 10), true);
  verifyEqual(testCase, is_transient_nlin_sdsos(r, {{fx2, x}}, 10), true);
  verifyEqual(testCase, is_transient_nlin_sdsos(r, {{fx1, x}, {fx2, x}}, 10), false);
end
...
function test_disturbance(testCase)
  ...
  verifyEqual(testCase, is_transient_nlin_sdsos(r, {{A*x+B, x}}, 10), true);
  verifyEqual(testCase, is_transient_nlin_sdsos(r, {{A*x+B+E*d, x, d, drec}}, 10), false);
