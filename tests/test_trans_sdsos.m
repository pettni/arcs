...
function test_trans1(testCase)
	...
	K = [1; 0];
	x = sdpvar(2,1);
	verifyEqual(testCase, is_trans_nlin_sdsos(r1, r2, {A*x + K, x}, 10), true);
...
function test_nonl(testCase)
  ...
  r1 = Rec([-1 0; 0 0.8]);
  r2 = Rec([0 0; 1 0.8]);
  verifyEqual(testCase, is_trans_nlin_sdsos(r1, r2, {f, [x; y]}, 10), true);
  verifyEqual(testCase, is_trans_nlin_sdsos(r2, r1, {f, [x; y]}, 10), false);

  r1 = Rec([-1 0; 0 1.2]);
  r2 = Rec([0 0; 1 1.2]);
  verifyEqual(testCase, is_trans_nlin_sdsos(r2, r1, {f, [x; y]}, 10), true);
