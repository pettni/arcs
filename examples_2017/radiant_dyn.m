...
function [DYN_A1, DYN_K1, DYN_E1, DYN_A2, DYN_K2, DYN_E2] = radiant_dyn()
	...
	disp(['$r_{1o}=r_{2o}=', num2str(r_1o), '$, ', ...
			  '$r_{1c}=r_{2c}=', num2str(r_1c), '$, ', ...
			  '$r_{cw}=', num2str(r_cw), '$'])
	disp(['$R_{1c} = \frac{r_{1c}}{A_{1c}} = ', num2str(R_1c), '$'])
	disp(['$R_{1o} = \frac{r_{1o}}{A_{1o}} = ', num2str(R_1o), '$'])
	disp(['$R_{2c} = \frac{r_{2c}}{A_{wc}} = ', num2str(R_2c), '$'])
	disp(['$R_{2o} = \frac{r_{2o}}{A_{2o}} = ', num2str(R_2o), '$'])
	disp(['$R_{12} = \frac{r_{12}}{A_{12}} = ', num2str(R_12), '$'])
	disp(['$R_{cw} = \frac{r_{cw}}{A_{cw}} = ', num2str(R_cw), '$'])
	disp(['$C_{1} = 5 c_a \rho_a V_1 = ', num2str(C1), '$'])
	disp(['$C_{2} = 5 c_a \rho_a V_2 = ', num2str(C2), '$'])
	disp(['$C_{c} = c_c \rho_c V_c = ', num2str(Cr), '$'])
	disp(['$q_{1} = q_1 = \left(', num2str(q1) , '\frac{W}{m^2} \right) \times A_{1c}$'])
	disp(['$q_{1} = q_2 = \left(', num2str(q2) , '\frac{W}{m^2} \right) \times A_{1c}$'])
